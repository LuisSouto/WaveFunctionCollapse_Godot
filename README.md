...
## Usage
The implementation of the WFC algorithm is encapsulated in the WFC Godot class. The list of methods and members is provided in the Godot documentation included in this repo. The most important is the Config property, an instance of the WFCConfig class. There you can specify settings like the size of the output image, periodicity conditions, pattern length, etc.
